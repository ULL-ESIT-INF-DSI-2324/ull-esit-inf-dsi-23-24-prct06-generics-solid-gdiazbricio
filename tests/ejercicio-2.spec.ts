...
const myFirstBill = new Bill("Suso Santana", "Movistar", "17/02/23", 2301.92, [
  "Iphone 12 - 126GB",
  "AirBook Pro",
]);
const mySecondBill = new Bill(
  "Alvaro Jimenez",
  "PcComponentes",
  "29/07/22",
  532.21,
  ["Pc Sobremesa (Intel Core i5, 8GB RAM DDR4, Nvidia GTX 1050...)"]
);
...
describe("exercise 2 tests", () => {
  ...
  it("billinHTML must print bills in HTML format", () => {
    expect(myBillInHTML.print()).to.be.equal(
      "<h1>FACTURA</h1> <p><strong>Cliente:</strong> Suso Santana</p><p><strong>Proveedor:</strong> Movistar</p><p><strong>Fecha:</strong> 17/02/23</p><p><strong>\nProductos:</strong> Iphone 12 - 126GB, AirBook Pro</p><p><strong>\nPrecio total:</strong> 2301.92</p>"
    );
  });

  it("billinHTML must set bill to given bill", () => {
    myBillInHTML.setBill(mySecondBill);
    expect(myBillInHTML.print()).to.be.deep.equal(
      "<h1>FACTURA</h1> <p><strong>Cliente:</strong> Alvaro Jimenez</p><p><strong>Proveedor:</strong> PcComponentes</p><p><strong>Fecha:</strong> 29/07/22</p><p><strong>\nProductos:</strong> Pc Sobremesa (Intel Core i5, 8GB RAM DDR4, Nvidia GTX 1050...)</p><p><strong>\nPrecio total:</strong> 532.21</p>"
    );
  });

  it("billinPDF must print bills in PDF format", () => {
    expect(myBillInPDF.print()).to.be.equal(
