...
describe('Exercise 1 tests', () => {
  it('getElements returns the elements inside a box', () => {
    expect(myBox2.getElements()).to.be.deep.equal([{name: "objeto 4", size: 5}, {name: "objeto 5", size: 7}]);
  });
  ...
  it('addElement adds an element  to a box', () => {
    ...
    expect(myBox2.getElements()).to.be.deep.equal([{name: "objeto 4", size: 5}, {name: "objeto 5", size: 7}, {name: "objeto 6", size: 3}]);
  });
  ...
  it('findInMoving returns a string with the box that contains the element', () => {
    ...
    expect(myMovingFinder.find()).to.be.equal("objeto 1 se encuentra en la caja 1");
  });
  ...
  it('printMoving returns a string with the boxes that contains the moving and its elements', () => {
    ...
    expect(myMovingPrinter.print()).to.be.equal("La caja 2 contiene: \n- objeto 4 \n- objeto 5 \nLa caja 1 contiene: \n- objeto 1 \n- objeto 2 \n");
  });
});