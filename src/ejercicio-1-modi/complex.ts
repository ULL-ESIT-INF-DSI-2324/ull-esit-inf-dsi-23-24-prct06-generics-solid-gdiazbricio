...
export class Complex implements Arithmeticable<Complex>{
  ...
  add(arithmetic: Complex): Complex {
    return new Complex(this.num1 + arithmetic.num1, this.num2 + arithmetic.num2);
  }
  ...
  multiply(arithmetic: Complex): Complex {
    return new Complex(this.num1 * arithmetic.num1 - this.num2 * arithmetic.num2, this.num1 * arithmetic.num2 + this.num2 * arithmetic.num1);
  }
  ...
  divide(arithmetic: Complex): Complex {
    const numerator = this.multiply(new Complex(arithmetic.num1, -arithmetic.num2));
